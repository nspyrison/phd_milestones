...
output: 
    ...
    bookdown::pdf_document2: 
      includes:
        #in_header: import.sty ## #Preamble covered in .yaml `header-includes`
        before_body: title.sty
        after_body: "`r knitr::knit('spyrison-cook-marriott.Rmd')`"
      keep_tex: yes
      number_sections: yes
      #toc_depth: 2
...
<!-- (+ 10 days for full) SciVis - Empirical Study\ -->

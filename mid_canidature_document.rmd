...
Paper accepted in the R Journal, available in the first issue 2020 [https://journal.r-project.org/]. 

## Software 

R package accepted on CRAN [https://cran.r-project.org/web/packages/spinifex/index.html]. 

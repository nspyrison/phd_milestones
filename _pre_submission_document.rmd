...
To illustrate SHAP we use a dataset of FIFA soccer player, a subset of 5000 player, observations of 42 wage and skill variables[@leone_fifa_2020]. Following the work in [@biecek_dalex_2018, @biecek_explanatory_2021] we can can extract SHAP values and also create a "break down" profile explaination of the observations prediction. Such an additive explaination has an asymmetry to the ordering of its variables. Let's take a look at the SHAP and break downs of a star offensive and defensive player

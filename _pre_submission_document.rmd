...
```{r studyResults, echo=FALSE, out.width = "49%", out.extra = '',fig.show='hold',fig.align='center', fig.cap = "TODO:XXX ADD caption"}
...
knitr::include_graphics(c("figures/spinifex_study_y1_results.PNG",
...
```{r cheemShapBd, echo=FALSE, out.width = "100%", out.extra = '',fig.show='hold',fig.align='center', fig.cap = "SHAP vlaues and prediction explainations of an offensive player (Messi, top) and a defensive player (van Dijk). SHAP values show change in weights at the location of each player. Break down profiles show one order sensitive explaination for the prediction of that observation."}
knitr::include_graphics("figures/cheem_fifa_messi_dijk.pdf")
```
```{r cheemAppPenguins, echo=FALSE, out.width = "100%", out.extra = '',fig.show='hold',fig.align='center', fig.cap = "TODO:XXX caption"}
knitr::include_graphics("figures/cheem_pca_qq_maha.PNG")
```
```{r cheemAppPenguins2, echo=FALSE, out.width = "100%", out.extra = '',fig.show='hold',fig.align='center', fig.cap = "TODO:XXX caption"}

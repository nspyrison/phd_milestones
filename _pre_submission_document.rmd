...
### SHAP values and prediction explanations.

To illustrate SHAP we use a dataset of FIFA soccer players (2020 season), a subset of 5000 players, observations of 42 wage, and skill variables[@leone_fifa_2020]. Following the work in [@biecek_dalex_2018, @biecek_explanatory_2021] we can extract SHAP values and also create a "break down" profile explanation of the observations prediction. Such an additive explanation has an asymmetry to the ordering of its variables. The figure below take a look at the SHAP and break down profiles of a star offensive and defensive player.

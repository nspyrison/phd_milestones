...
#TODO: XXX
Any space that deviates from this restriction is called a _non-linear_ projection/embedding.

#TODO: XXX
Developing new methods to visualize high dimensions has been a pursuit of statisticians, computer scientists, and visualization researchers for decades.


<!-- getting into interaction here -->
While static documents are the norm, there remains some benefit of user interaction to help the analyst understand results, and determine the importance of components in a model. An interplay between automated and human control is useful. As technology changes, new approaches to user interaction emerge, and exploring these technologies provides a challenge to researchers.
...
3. **Can we use the geodesic interpolator in conjunction with agnostic non-linear models to improve their interprebility?**\
#TODO:XXX

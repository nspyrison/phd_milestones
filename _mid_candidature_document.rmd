...
__Tasks 1 and task 2 aggreageted to take levl:__

```{r v3pilot, echo=FALSE, out.width = "100%", out.extra = '', fig.cap = "Proposed research timeline."}
knitr::include_graphics("figures/v3pilot.png")
```
...
Special care must be taken defining the the The 4D rotation matrix must be solved, again with appliation of Rodrigues' rotation formula [@rodrigues_lois_1840]. 

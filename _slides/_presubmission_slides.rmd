...
author: "<br> Nicholas Spyrison <br> Monash University"
date: "Presubmission seminar <br> 17 September 2021 <br><br> _Slides -- [github.com/nspyrison/phd_milestones/_slides/](https://github.com/nspyrison/phd_milestones/_slides/)_"
output:
...
- Data visualization *tour*; continuous linear projection over small changes in the projection basis
- *radial tour* (RO#1); given a basis, variable and direction to change using geodesic interpolator, to change it's contribution
...
- Exploratory Artificial Intelligence (XAI), growing tension of accuracy and interpretability of black-box models.
...
knitr::include_graphics("./slide_figures/study_exp_factors.png")
```
]
...
knitr::include_graphics("./slide_figures/figBiplotScoring.png")
```
...
- SHAP, model-agnostic local explanation, as applied to random forest models
- Approximate variable importance to the model; median importance, permuting over combinations of the explanatory variables
]

.pull-right[
```{r echo = F, out.width = '100%'}
knitr::include_graphics("./slide_figures/cheem_fifa_messi_dijk.png")
```
]
...
- Compare initial with full contribution with no contribution
]

.pull-right[
```{r echo = F, out.width='110%', out.height='610px'}
rt_anim
```
]
...
Slides available -- [github.com/nspyrison/phd_milestones/_slides](https://github.com/nspyrison/phd_milestones/_slides)
<br>

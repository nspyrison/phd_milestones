...
- Efficacy of the radial tour (RO#2); user study measuring against PCA and grand tour (target bases randomly select)
- In exploratory artificial intelligence, _local explanations_ explore variable importance at one observation
    - Further explore with the radial tour (RO#3)
...
- 3) Can the radial tour be used in conjunction with the local explanation, SHAP, to improve the interpretability of black-box models?

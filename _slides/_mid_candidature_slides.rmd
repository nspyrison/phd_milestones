...
Linear projection are specified by their basis
...
Process selecting intermediate bases along the shortest path of orthonormal bases.
...
- 4) Does geodesic interpolation in 3D provide advantages over 2D for understanding structure in linear projections? (3D GI structure study)

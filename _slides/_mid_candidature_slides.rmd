...
A linear projection is specified by its basis, which is the combination of variables that map to dimension space.

- Must be orthonormal: all dimensions at right angles and of length 1
...
## Geodesic interpolator (GI)

_Geodesic interpolation_ is the selection of intermediate frames along the shortest path that is orthonormality restricted.
...
- Illustrated through GI, changing the contribution of an individual variable

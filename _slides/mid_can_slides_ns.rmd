...
## 2D GI structure study (addressing RO #2) (pg 1/5)
...
## 2D GI structure study (addressing RO #2) -- Design (pg 2/5)

<!-- - Participant is assigned to one of 3 _groups_ controling factor order -->
<!-- - Within each _factor_ there are 2 _tasks_ -->
<!--     - Task 1) identify the number of clusters in the dat -->
<!--     - Task 2) rate the importance of all variables for distinguishing between 2 clusters -->
<!-- - Each task is performed on simulations of 3 blocks of increasing difficulty -->
<!-- - Proceed to the next factor and performs tasks again -->
...
## 2D GI structure study (addressing RO #2) -- Evaluation interface for (pg 3/5)


```{r, echo = F, out.width = '100%', out.height = '100%'}
knitr::include_graphics("./slide_figures/appInterface_GI.png")
```

---

## 2D GI structure study (addressing RO #2) -- Measures and response (pg 4/5)

- Log file capturing every action
- During evaluation:
    - response, time, number and type of interaction
- Post study survey:
    - demographics: age, sex, education, Enlish primarly language, visualization and multivariate familiarity
    - per factor (9 point Likert): familiarity, ease, confidence, and likability


---

## 2D GI structure study (addressing RO #2) -- Status (pg 5/5)
...
- Pilot studies
- Fine tuning block difficulty

Next steps:

- Run the study, planning on $n = 24$
- Analysis

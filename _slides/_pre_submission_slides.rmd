...
- 3) Can the _radial tour_ be used in conjunction with the local explanations to improve the interpretability of black-box models?
- *fundamental visualization design*, how can we best view the sensitivity of the local explanation, and what can we gain by exploring a single local explanation with radial tours
...
- Block factors: _location_ mixing of signal and noise var, _shape_ of distribution, and _dim_ensionality of the data.
